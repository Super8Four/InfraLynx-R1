...
import { createDeviceType, deleteDeviceType } from "../actions"

interface DeviceTypesPageProps {
  initialTypes: DeviceType[];
}
...
export function DeviceTypesClientPage({ initialTypes }: DeviceTypesPageProps) {
  const { toast } = useToast()
  const [types, setTypes] = useState<DeviceType[]>(initialTypes)
