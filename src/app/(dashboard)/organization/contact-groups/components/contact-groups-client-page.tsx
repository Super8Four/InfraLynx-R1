...
import { createContactGroup, deleteContactGroup } from "../actions"
...
export function ContactGroupsClientPage({ initialGroups }: ContactGroupsPageProps) {
  ...
  async function onSubmit(data: GroupFormValues) {
    ...
    if (result.success && result.newGroup) {
        ...
        toast({ title: "Success", description: "Contact group has been created." });
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Manage groups of contacts.</CardDescription>
            </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g., NOC Team" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
