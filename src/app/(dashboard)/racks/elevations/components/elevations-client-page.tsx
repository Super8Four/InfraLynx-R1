...
export function RackElevationsClientPage({ initialRacks, initialDevices, initialSites, initialDeviceTypes, initialDeviceRoles }: RackElevationsPageProps) {
    const { toast } = useToast()
    const [allRacks] = useState<RackType[]>(initialRacks)
